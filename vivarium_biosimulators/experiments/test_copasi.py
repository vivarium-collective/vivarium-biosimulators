"""
Test Biosimulator's COPASI API
========================================

Execute by running: ``python vivarium_biosimulators/processes/test_copasi.py``
"""
...
def test_copasi_process(
    ...
    # config
    config = {
        'biosimulator_api': 'biosimulators_copasi',
...
def run_once(
    ...
    plot_simulation_output(
        ...
        plot_settings,
        out_dir='out/copasi',
        filename=f'copasi_dt={dt_str}_ttotal={total_time}.png',
    )
...
# run with python vivarium_biosimulators/experiments/test_copasi.py -n [exp_library_id]
